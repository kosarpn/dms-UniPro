...
"""
تشخیص ترکیبی چهره با MediaPipe و YOLO
...
class HybridDetector:
    ...
    - اولویت اول: MediaPipe (468 نقطه، دقت بالا)
    - Fallback: YOLO (5 نقطه، برای شرایط سخت)
    """
    ...
    def __init__(self,
        ...
        """
        Args:
            mediapipe_confidence: آستانه اطمینان MediaPipe
            yolo_confidence: آستانه اطمینان YOLO
            fallback_threshold: تعداد خطاهای متوالی برای Fallback
        """
    ...
    def _init_detectors(self):
        ...
        try:
            ...
            print("[HybridDetector] MediaPipe initialized")
        except Exception as e:
            print(f"[HybridDetector] MediaPipe not available: {e}")
    ...
    def detect(self, frame: np.ndarray) -> HybridResult:
        """
        تشخیص چهره با روش ترکیبی
        
        Returns:
            HybridResult شامل نقاط کلیدی و اطلاعات تشخیص
        """
        self.total_frames += 1
    ...
    def _should_fallback(self) -> bool:
        """آیا باید به YOLO Fallback کنیم؟"""
